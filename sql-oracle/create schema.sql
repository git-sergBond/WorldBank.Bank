...
CREATE TABLE balance (
    ...
    balance_ruble NUMBER(38) NOT NULL,
    balance_dollar NUMBER(38) NOT NULL,
    balance_euro NUMBER(38) NOT NULL,
    FOREIGN KEY (account_id) REFERENCES account (id)
);
CREATE UNIQUE INDEX IDX_balance_01 ON balance(account_id);
